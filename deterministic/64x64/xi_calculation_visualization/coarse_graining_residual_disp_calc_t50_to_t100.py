...
outfile = File("./results/coarse_grained_vel_64_grid_c_1_by_64_t=50_to_t=100.pvd")
data_file = "./KE_data/coarse_graining_residual_disp_calc_t50_to_t100_data_mesh_64.txt"
KE = []
