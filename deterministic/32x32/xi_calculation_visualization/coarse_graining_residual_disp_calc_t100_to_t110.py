...
outfile = File("./results/coarse_grained_vel_32_grid_c_1_by_32_t=100_to_t=110.pvd")
data_file = "./KE_data/coarse_graining_residual_disp_calc_t100_to_t110_data_mesh_32.txt"
KE = []
