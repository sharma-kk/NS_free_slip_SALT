...
data_file ='./fields_as_arrays/u_adapted_sol_arrays_mesh_32_at_t_50.0.npz'
...
t = 50.0 + Dt
iter_n = 1
freq = 5 # saving vel. data every 1 time unit
big_t_step = freq*Dt 
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file ='./fields_as_arrays/u_adapted_sol_arrays_mesh_32_at_t_'+str(round(t,4))+'.npz'
