...
outfile = File("./results/deterministic_adapted_coarse_grained_fields_grid_32_t50_to_t90.pvd")
...
for i in t_stamps:
    ...
    data_cg = np.load('./fields_as_arrays/u_coarse_grained_arrays_mesh_32_at_t_'+str(i)+'.npz')
    data_det = np.load('./fields_as_arrays/u_deter_sim_arrays_mesh_32_at_t_'+str(i)+'.npz')
    data_ad = np.load('./fields_as_arrays/u_adapted_sol_arrays_mesh_32_at_t_'+str(i)+'.npz')
    ...
    data_file = './l2_error_pattern_cor_data/det_vs_adap_vs_truth_grid_32_t50_to_t90.npz'
