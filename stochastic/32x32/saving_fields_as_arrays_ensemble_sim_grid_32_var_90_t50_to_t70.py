...
seed_no = ensemble_comm.rank + 70 # seed no.
...
xi_data = np.load('../xi_calculation/calculated_xi_vectors/xi_matrix_56_eigvec_c_1_by_32_decor_t_1_Dt_t=50_to_t=110.npz')
...
n_EOF = 23 # 23 EOFs covers 90 percent variance
...
data_file = './ensemble_vel_data_as_arrays/stoch_sim_mesh_32_var_90_particle_'+str(particle_no)+'_fields_data_at_t_50.0.npz'
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq_stoc == 0:
        ...
        data_file = './ensemble_vel_data_as_arrays/stoch_sim_mesh_32_var_90_particle_'+str(particle_no)+'_fields_data_at_t_'+str(round(t,4))+'.npz'
