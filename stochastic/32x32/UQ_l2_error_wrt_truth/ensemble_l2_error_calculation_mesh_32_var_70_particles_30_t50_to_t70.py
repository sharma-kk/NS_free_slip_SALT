...
n_particles = 30 # no. of particles in the ensemble; this depends on the no. of particles for which data is available
var_level = 70
grid = 32
...
for i in t_stamps:
    ...
    data_t = np.load('../../../deterministic/32x32/global_comparison/fields_as_arrays/u_coarse_grained_arrays_mesh_32_at_t_'+str(i)+'.npz')
