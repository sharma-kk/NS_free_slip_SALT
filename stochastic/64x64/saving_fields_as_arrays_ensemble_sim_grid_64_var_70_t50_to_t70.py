...
seed_no = ensemble_comm.rank + 90 # seed no.
...
n_EOF = 14 # 14 EOFs covers 70 percent variance
...
data_file = './ensemble_vel_data_as_arrays/stoch_sim_mesh_64_var_70_particle_'+str(particle_no)+'_fields_data_at_t_50.0.npz'
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq_stoc == 0:
        ...
        data_file = './ensemble_vel_data_as_arrays/stoch_sim_mesh_64_var_70_particle_'+str(particle_no)+'_fields_data_at_t_'+str(round(t,4))+'.npz'
